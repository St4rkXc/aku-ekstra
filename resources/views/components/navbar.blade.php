		...
		<div class="navbar bg-transparent  mx-auto w-full border bg-white border-black/15 rounded-md lg:px-8 px-4 py-4">
			<div class="navbar-start flex items-center space-x-4">
				<div class="flex items-center ">
                    ...
                    <a class="text-text text-xl ml-3 font-bold ">Gastix</a>
                </div>
			...
			<div class="navbar-end flex space-x-3">
				...
				<div class="dropdown dropdown-end">
					...
					<ul tabindex="0"
						...
						<li><a href="#about" class="text-white font-semibold hover:bg-base-100/30 duration-500 p-4">Product</a></li>
						<li><a href="#gallery" class="text-white font-semibold hover:bg-base-100/30 duration-500 p-4">Company</a></li>
						<li><a href="#book" class="text-white font-semibold hover:bg-base-100/30 duration-500 p-4">Features</a></li>
						<li><a href="#book" class="text-white font-semibold hover:bg-base-100/30 duration-500 p-4">Profile</a></li>
					</ul>
				</div>
			</div>
		</div>
